...
public class ARTrackedObject : MonoBehaviour
{
	...
	// Gerallt's modifications
	public delegate void OnMarkerTrackedDelegate(ARMarker marker);
	public static event OnMarkerTrackedDelegate OnMarkerTrackedEventHandler;
			...
			if (origin == null) {
				...
				if (marker == null) {
					...
					if (baseMarker != null && marker.Visible) {
						...
						if (OnMarkerTrackedEventHandler != null)
							OnMarkerTrackedEventHandler (marker);
